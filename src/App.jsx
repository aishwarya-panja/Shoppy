          ...
          <div className="flex relative dark:bg-main-dark-bg">
            <div className="fixed right-4 bottom-4" style={{ zIndex: "1000" }}>
              ...
              <TooltipComponent content="Settings" position="Top">
                {/* ToolTipComponent - reusable UI element that displays a small informational message when the user hovers over/focuses on/clicks on another element(icon) on the page */}
                <button
                  type="button"
